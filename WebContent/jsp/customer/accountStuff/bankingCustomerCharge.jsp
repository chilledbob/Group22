...
<div id="middle">
	<div class="main_content_full">
		<div class="current_content">
			...
			<h4 align="center">Banking Abbuchen<sup style="text-shadow: aqua;font-size: x-small;">${currentUser.identifier}</sup></h4>
			...
			<div align="center">
				<a href ="bankingCustomer">Aufladen</a>
				<a href ="bankingCustomerCharge">Abbuchen</a>
				<a href ="cancelEditingCustomer">Abbrechen</a>
			</div>	
			
			<form id="form" action="loading" method="post" style="border:0px;"> 
				<table>
					<tr>
				...
				<div class="button1" align="center">
					<button class="btn" value="loading">Aufladen</button>
					<button class="btn" value="charging">Abbuchen</button>
				</div>
			</form>
