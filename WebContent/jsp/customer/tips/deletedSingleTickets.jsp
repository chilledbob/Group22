...
<div id="middle">
	<div class="main_content">
		...
		Ticket wurde erfolgreich gelöscht!<br>
		Ihr Geld wurde zurückgebucht.<br>
		<a href="${url }">zurück zur Übersicht</a>
		</c:when>
		<c:otherwise>
			<c:url value="customerTips" var="url">
				<c:param name="uid" value="${currentUser.identifier }" />
			</c:url>
			Es ist nicht mehr genügend Zeit um Änderungen vorzunehmen!<br>
			<a href="${url }">zurück zur Ticketübersicht</a>
		</c:otherwise>
		</c:choose>
		</div>
	</div>
