...
<div id="middle">
	...
	<c:url value="customerChangeTipWLTip" var="url">
		<c:param name="uid" value="${currentUser.identifier }"/>
	...
	<tr>
	<c:forEach var="i" items="${singleTT.getTip().getTip()}">
		<td>
	...
	<form action="${url }" method="post">
		...
		<input type="text" id="anzahl" name="anzahl" size="2" onchange="javascript:alert('Sie wollen '+document.getElementById('anzahl').value+' Tipscheine kaufen.')"> Bitte Anzahl der Tipscheine eintragen.<br><br>
