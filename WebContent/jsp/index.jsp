	...
	<div class="main_content">
		<div class="current_content">
			...
			<sp:forEach var="u" items="${userListe}">
				${u.getClass() } | Loginname: ${ u.getIdentifier() } | Loginpw: ${u.getIdentifier() } | und hier existiert evtl ein MemberDataUpdateRequest-Objekt${u.getMemberDataUpdateRequests() }
				${u.getMemberData().getAdress().getStreetName() } ${ u.memberData.adress.postCode }<br>
			</sp:forEach><br>
