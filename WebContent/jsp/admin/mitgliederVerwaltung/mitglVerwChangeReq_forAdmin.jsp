...
<div id="middle">
	<div class="main_content_full">
		<div class="current_content">
			...
			<div align="center">
				<c:url value="adminChangeReq_forAdmin" var="url1">
					<c:param name="filter" value="Admin" />
				</c:url>
				<c:url value="adminChangeReq_forAdmin" var="url2">
					<c:param name="filter" value="Employee" />
				</c:url>
				<c:url value="adminChangeReq_forAdmin" var="url3">
					<c:param name="filter" value="Customer" />
				</c:url>
				<c:url value="adminChangeReq_forAdmin" var="url4">
					<c:param name="filter" value="Notary" />
				</c:url>
				<c:url value="adminChangeReq_forAdmin" var="url5">
					<c:param name="filter" value="All" />
				</c:url>
