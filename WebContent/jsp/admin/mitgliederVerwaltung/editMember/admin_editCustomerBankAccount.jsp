...
<div id="middle">
	<div class="main_content_full">
		<div class="current_content">
			...
			<h4 align="center">Kontodaten von ${editMember.identifier}<sup style="text-shadow: aqua;font-size: x-small;">${editMember.getTypeAsGerman().toString()}</sup></h4>  
		...
		<form id="form" action="adminChangeCustomerRealAccount" method="post" style="border:0px;"> 
			<table>
				<tr>
					<td><label for="newBankCode">Bankleitzahl</label></td>
					<td><input name="newBankCode" id="newBankCode" type="text" size="30" maxlength="30" value="${editMember.getBankAccount().getRealAccountData().getBankCode()}"/></td>
				</tr>
				<tr>
					<td><label for="newAccountNumber">Kontonummer</label></td>
					<td><input name="newAccountNumber" id="newAccountNumber" type="text" size="30" maxlength="30" value="${editMember.getBankAccount().getRealAccountData().getAccountNumber()}"/></td>
				</tr>
			</table>
